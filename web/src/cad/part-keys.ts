...
export function partKeys(settings: Settings, d: DerivedDimensions) {
  return {
    ...
    tray: JSON.stringify([d.trayStyle, d.screwXs, d.screwYs, d.drop, d.length, d.width, d.rim, d.joinZ, d.deckThickness, d.deckTop, d.top, d.baseScrewHeadSeat, d.funnelBasePocketDepth, d.sliderInsetY, d.joints, d.registration, d.magnets, d.magnetPocketDiameter, d.magnetPocketDepth, settings.joint]),
    funnel: JSON.stringify([d.length, d.width, d.funnelOutletX, d.funnelDepth, d.funnelSlopeZ, d.registration, d.funnelMountZ, d.funnelBasePocketDepth, d.funnelMounts, d.magnetPocketDiameter, d.magnetPocketDepth, settings.funnelAlignment, settings.funnelOutlet]),
