import { SCREW_PRESETS, type Settings } from './cad'
...
export const SETTINGS_FIELDS: readonly Field[] = [
  { key: 'rows', group: 'basic', label: '1回に出す本数', description: '引く方向と直交する穴の数です。', kind: 'number', unit: '本', min: 1, max: 20, step: 1 },
  { key: 'columns', group: 'basic', label: '取り出し回数', description: '引き出して取り出せる回数です。', kind: 'number', unit: '回', min: 1, max: 30, step: 1 },
