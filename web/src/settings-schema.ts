...
export function getSettingsFields(language: Language): readonly Field[] {
  ...
  return [
    ...
    { key: 'funnelAlignment', category: 'operation', label: t('fieldFunnelAlignment'), description: t('fieldFunnelAlignmentDescription'), kind: 'select', options: [{ value: 'magnets', label: t('magnets') }, { value: 'pegs', label: t('pegs') }, { value: 'screws', label: t('screws') }] },
    ...
    { key: 'funnelHeight', category: 'operation', label: t('fieldFunnelHeight'), description: t('fieldFunnelHeightDescription'), kind: 'number', unit: 'mm', min: 9, max: 160, step: 1, optional: true },
