...
export const SETTINGS_CATEGORIES: readonly { id: SettingsCategory; label: string; description: string }[] = [
  ...
  { id: 'magnet', label: 'ふたの位置合わせ', description: '磁石または凹凸の寸法' },
...
export const SETTINGS_FIELDS: readonly Field[] = [
  ...
  { key: 'lidAlignment', category: 'operation', label: 'ふたの位置合わせ', description: '磁石を使うか、ふた側の凸とトレー側の穴で合わせるかを選びます。', kind: 'select', options: [{ value: 'magnets', label: '磁石' }, { value: 'pegs', label: '凹凸' }] },
  ...
  { key: 'detentSpringLength', category: 'operation', label: 'ばね長さ', description: '短くするとクリック用の板ばねが硬くなります。', kind: 'number', unit: 'mm', min: 6, max: 18, step: 0.5 },
  { key: 'detentDiameter', category: 'operation', label: 'クリックの凹凸径', description: 'スライダーの凸径です。ベース側の凹径は0.2 mm大きく作ります。', kind: 'number', unit: 'mm', min: 2, max: 3.2, step: 0.1 },
  ...
  { key: 'magnetDiameter', category: 'magnet', label: '磁石 / 凹凸の基準径', description: '磁石の実測直径、または凹凸モードの受け穴の基準直径です。', kind: 'number', unit: 'mm', min: 3, max: 8, step: 0.1 },
  { key: 'magnetThickness', category: 'magnet', label: '磁石の厚み / 受け穴の深さ', description: '磁石の実測厚み、または凹凸モードの受け穴の基準深さです。', kind: 'number', unit: 'mm', min: 1, max: 3, step: 0.1 },
  ...
  { key: 'magnetDiameterClearance', category: 'clearance', label: '位置合わせ穴の径クリアランス', description: '磁石または凹凸の基準径に加える余裕です。', kind: 'number', unit: 'mm', min: 0, max: 0.6, step: 0.05 },
  { key: 'magnetDepthClearance', category: 'clearance', label: '位置合わせ穴の深さクリアランス', description: '磁石の厚みまたは凹凸の基準深さに加える余裕です。', kind: 'number', unit: 'mm', min: 0, max: 0.3, step: 0.05 },
]
